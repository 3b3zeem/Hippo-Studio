...
export function sidebar(){
    ...
    <div class="sidebar-list">
        ...
        <p class="title">Movies <i class="fa-solid fa-arrow-turn-down"></i> </p>
        </div>
    ...
    <div class="sidebar-footer">
        <p class="copyright">Copyright 2023 <a href="https://www.facebook.com/ahmed.mostafa.224722">Hippo</a>
        </p>
